    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#selectImageButton').on('click', function (e) { 
                ...
                if (selectedInputId && selectedPreviewId) { 
                    $('#' + selectedInputId).val(selectedFileUrl); 
                    $('#' + selectedPreviewId).attr('src', selectedFileUrl); 
                }
                ...
                alertify.success('Image selected successfully!');
            });
