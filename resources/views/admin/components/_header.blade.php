<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('dashboard') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        {{-- <img src="{{ asset('assets/frontend/img/logo.png') }}" alt="" height="24"> --}}
                    </span>
                    <span class="logo-lg">
                        {{-- <img src="{{ asset('assets/frontend/img/logo.png') }}" alt="" height="24"> --}}
                         <span
                            class="logo-txt">Onc Brothers</span>
                    </span>
                </a>
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="{{url('/')}}" class="view_website mx-2" target="_blank" title="View Website">
                 <i data-feather="globe" class="icon-sm me-2"></i>View website
            </a>
