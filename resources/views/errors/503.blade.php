...
<head>
    ...
    <meta charset="utf-8" />
    <title>Maintenance | Onc Brothers</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Premium Multipurpose Admin & Dashboard Template" name="description" />
    <meta content="einnovention" name="author" />
    <!-- App favicon -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center mb-5">
                                <h1 class="display-1 fw-semibold">We're<span class="text-primary mx-2">Launching</span>Soon</h1>
                                <h4 class="text-uppercase">website Is Under Maintenance</h4>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10 col-xl-8">
                            <div>
                                <img src="{{ asset('assets/admin/src/images/error-img.png') }}" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
