                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center mb-5">
                                <h1 class="display-1 fw-semibold">5<span class="text-danger mx-2">0</span>0</h1>
                                <h4 class="text-uppercase">Internal Server Error. Something went wrong.</h4>
                                <div class="mt-5 text-center">
                                    <a class="btn btn-danger waves-effect waves-light"
                                        href="javascript:window.location.reload()">Reload</a>
                                </div>
                            </div>
                        </div>
                    </div>
