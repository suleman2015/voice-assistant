...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="fw-bold">Tags Management</h4>
            @can('tags.create')
        ...
        <div class="card">
            <div class="card-body table-responsive">
                <table class="table table-bordered align-middle" id="tags-table">
    ...
    <script>
        $(function () {
            ...
            $(document).on('click', '.delete-btn', function () {
                ...
                const tagName = $(this).data('name') || 'this tag';
                const actionUrl = "{{ route('tags.destroy', ':id') }}".replace(':id', tagId);
