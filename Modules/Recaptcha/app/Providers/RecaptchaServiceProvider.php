...
use Modules\Recaptcha\Http\Middleware\VerifyRecaptcha;
...
class RecaptchaServiceProvider extends ServiceProvider
{
    ...
    protected string $nameLower = 'recaptcha';
    ...
    public function boot(): void
    {
        ...
        if (Schema::hasTable('recaptcha_settings')) {
            ...
            if ($setting) {
                config([
                    'captcha.sitekey' => $setting->site_key,
                    'captcha.secret'  => $setting->secret_key,
                ]);
            }
        }
    }
