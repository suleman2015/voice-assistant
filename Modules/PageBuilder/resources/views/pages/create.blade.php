                        ...
                        <form method="POST" action="{{ route('pages.store') }}">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-6 mb-3">
                                    <x-name-field name="title" label="Title" :value="old('title')" :required="true"
                                        data-generate-slug="#slug" />
                                </div>
                                <div class="col-md-6 mb-3">
                                    <x-slug-field name="slug" :value="old('slug')" :model="null" :id="null"
                                        :required="true" />
                                </div>
                                <x-editor-field label="Content" name="content" :value="old('content')" />
                                <x-seo-meta />
                            </div>
                            <div class="mt-3">
                                <button class="btn btn-primary mt-2" type="submit">{{ __('Create Page') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
